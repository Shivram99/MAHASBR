...
public class RegistryApiService {
	...
	private static final String DISH_URL = "https://sbrlmsapi.mahaitgov.in/api/SBR/GetSBRShopData";
    private static final String LABOUR_URL = "https://sbrlmsapi.mahaitgov.in/api/SBR/getSBRFactoryData";
    ...
    public static final Map<Integer, String> AUTHORITY_MAP = Map.ofEntries(
            Map.entry(21, "CHARITY"),
            Map.entry(22, "DISH"),
            Map.entry(23, "LABOUR"),
            Map.entry(24, "CO-OP"),
            Map.entry(25, "KVIB"),
    ...
    public CompletableFuture<Void> fetchLabour() { return fetchAndSave(ApiAuthConfig.LABOUR, "Labour", LABOUR_URL,"LABOUR"); }
    public CompletableFuture<Void> fetchCoop() { return fetchAndSave(ApiAuthConfig.COOP, "Co-Op Societies", COOP_URL,"CO-OP"); }
    public CompletableFuture<Void> fetchKvib() { return fetchAndSave(ApiAuthConfig.KVIB, "KVIB", KVIB_URL,"KVIB"); }
    public CompletableFuture<Void> fetchMcgm() { return fetchAndSave(ApiAuthConfig.MCGM, "MCGM", MCGM_URL,"MCGM"); }
    public CompletableFuture<Void> fetchMsme() { return fetchAndSave(ApiAuthConfig.MSME, "MSME", MSME_URL,"MSME"); }
    public CompletableFuture<Void> fetchMca() { return fetchAndSave(ApiAuthConfig.MCA, "MCA", MCA_URL,"MCA"); }
    public CompletableFuture<Void> fetchGstn() { return fetchAndSave(ApiAuthConfig.GSTN, "GSTN", GSTN_URL,"GSTN"); }
...
//                fetchGstn()
	...
	public void processSingleRecord(MstRegistryDetailsPagesDTO dto, String rawData,String apiName,String url,String registory) {
		// 1. Map DTO → Entity
	 ...
	 */
	@Transactional(propagation = Propagation.REQUIRES_NEW)
	public void saveFailedRecord(MstRegistryDetailsPagesDTO dto, String rawData, String reason, String apiName, String apiUrl) {
	    try {
	...
	public static Integer getKeyByValue(String value) {
	    return AUTHORITY_MAP.entrySet()
	            .stream()
	            .filter(entry -> entry.getValue().equalsIgnoreCase(value)) // case insensitive
