...
@Data
@NoArgsConstructor
@Table(name = "duplicate_reg_details")
@ToString
public class DuplicateRegistryDetailsPageEntity extends Auditable {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "siNo_generator_duplicate")
	@SequenceGenerator(name = "siNo_generator_duplicate", sequenceName = "siNo_sequence_duplicate", allocationSize = 1)
	@Column(name = "siNo")
	private Long siNo;
