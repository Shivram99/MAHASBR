...
@Data
@NoArgsConstructor
@Table(name = "concern_reg_details")
@ToString
public class ConcernRegistryDetailsPageEntity extends Auditable  {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "siNoc_generator")
	@SequenceGenerator(name = "siNoc_generator", sequenceName = "siNoc_sequence", allocationSize = 1)
	@Column(name = "siNo")
	private Long siNo;
	...
	@Column(length = 5)
	private Integer nic2008ActivityCodeDesicripton;
